      ...
      <div className="lg:col-span-7 flex flex-col gap-6">
        <div className="glass-panel rounded-2xl p-6 border border-card-border flex flex-col gap-4">
          ...
          <textarea
            ...
            className="w-full h-56 bg-zinc-950 border border-zinc-800 rounded-xl p-4 font-mono text-xs text-zinc-300 placeholder:text-zinc-700 focus:outline-none focus:border-purple-500/40 shadow-inner"
          />
        ...
        <div className="glass-panel rounded-2xl p-6 border border-card-border flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="bg-zinc-100 dark:bg-zinc-950 border border-card-border rounded-xl px-4 py-2 text-xs font-mono text-zinc-800 dark:text-zinc-350 focus:outline-none focus:border-purple-500/40"
            />
          </div>
              ...
              {COMMON_MIME_TYPES.map((t) => (
                <button
                  ...
                  className={`p-2 rounded-xl border text-[10px] text-center font-mono font-semibold transition-all cursor-pointer ${
                    selectedMime === t.mime
                      ? "bg-purple-600/10 border-purple-500 text-purple-600 dark:text-purple-300"
          ...
          <button
            ...
            disabled={!inputText}
            className={`w-full py-3 mt-2 rounded-xl text-xs font-semibold font-mono tracking-wide uppercase transition-all duration-300 shadow-lg cursor-pointer ${
              inputText
                ? "bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white shadow-purple-500/10 active:scale-[0.99] hover:shadow-purple-500/20"
